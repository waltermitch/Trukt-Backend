...
const orderController = require('../HttpControllers/OrderController');
...
router
    ...
    .post('/edi/204/inbound', controller.constructor.createTender, orderController.constructor.createOrder)
