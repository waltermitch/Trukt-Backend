...
{
    setImmediate(async () => { EDIService.sendCode({ order, job, stop, datetime }, 'X1'); });
});
...
{
    setImmediate(async () => { EDIService.sendCode({ order, job, stop, datetime }, 'X3'); });
});
...
{
    setImmediate(async () => { EDIService.sendCode({ order, job, stop, datetime }, 'AF'); });
});
