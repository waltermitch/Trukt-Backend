exports.up = function (knex)
{
    return knex.raw(`
        ...
        ALTER TABLE IF EXISTS rcg_tms.status_log_types RENAME TO activity_log_types;
        ...
        ALTER TABLE rcg_tms.activity_log_types RENAME CONSTRAINT status_log_types_category_name_unique TO activity_log_types_category_name_unique;
    `);
};
...
exports.down = function (knex)
{
    return knex.raw(`
        ...
        ALTER TABLE IF EXISTS rcg_tms.activity_log_types RENAME TO status_log_types;
