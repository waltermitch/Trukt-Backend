...
exports.up = function (knex)
{
    return knex.raw(`
        ...
        ALTER TABLE rcg_tms.order_jobs
        ADD rate_per_mile numeric(15,2) NOT NULL GENERATED ALWAYS AS (COALESCE(rcg_tms.order_jobs.transport_cost / COALESCE(NULLIF(rcg_tms.order_jobs.distance, 0), 1), 0)) STORED;
