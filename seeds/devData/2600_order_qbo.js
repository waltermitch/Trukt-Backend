...
exports.seed = async function (trx)
{
    ...
    const [
        ...
        SFAccount.query(trx).modify('byType', 'client').findOne(builder => builder.whereNotNull('guid').whereNotNull('qb_id')),
        SFAccount.query(trx).modify('byType', 'carrier').findOne(builder => builder.whereNotNull('guid').whereNotNull('qb_id')),
